...
class SearchFriendFormWidget extends StatefulWidget{
  @override
  SearchFriendFormWidgetState createState(){
    return SearchFriendFormWidgetState();
  }
}

class SearchFriendFormWidgetState extends State<SearchFriendFormWidget>{
  ...
  Future<dynamic> _users(String firstname) async{
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ListTile(
                                          ...
                                          onTap: () {
                                            session.set('friendID', snapshot.data[index]['userID']);
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
