...
class FollowerFormWidget extends StatefulWidget{
  @override
  FollowerFormWidgetState createState(){
    return FollowerFormWidgetState();
  }
}

class FollowerFormWidgetState extends State<FollowerFormWidget>{
