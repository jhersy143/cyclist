...
import '../Follow/chat_screen.dart';
import 'package:cyclista/flutter_session.dart';

class ViewProfileFormWidget extends StatefulWidget{
  @override
  ViewProfileWidgetState createState(){
    return ViewProfileWidgetState();
  }
}

class ViewProfileWidgetState extends State<ViewProfileFormWidget>{
  @override
  void initState() {
    super.initState();
